...
- الفصول السبعة الأولى من المجلد التأسيسي:
  1. التاريخ والمنهج.
...
- بدء الفصل الثامن عن مبرهنة ديريشليه للأوليات في المتتاليات الحسابية على فرع مستقل.
- حالة الفصل الثامن: `EVIDENCE-FIRST / PRE-AUTHORING`؛ يجري تثبيت خريطة الأدلة ومسار البرهان قبل كتابة النص النهائي.
