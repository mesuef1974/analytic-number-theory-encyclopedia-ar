...
% Amiri remains the Arabic script font.  Disable only common/contextual/
% discretionary ligatures so incidental Latin words in Arabic paragraphs do
% not reorder fi/fl/iff sequences.  Required Arabic shaping features remain
% enabled by the Script=Arabic shaper.
