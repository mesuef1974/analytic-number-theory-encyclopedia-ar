...
% Named indexes are generated automatically by imakeidx. Builds must allow the
% restricted shell escape needed to invoke makeindex; CI and local build
% commands provide -shell-escape explicitly.
\usepackage{imakeidx}
