...
% هوية المجلد داخل المشروع الموسوعي متعدد المجلدات. اسم المشروع الأعلى
% («الموسوعة الشاملة») ثابت؛ هذان الأمران وحدهما يتغيران عند إصدار مجلد لاحق.
\newcommand{\volumenumber}{المجلد الأول}
\newcommand{\volumetitle}{النواة التحليلية وتوزيع الأوليات والبوابات الحديثة}
