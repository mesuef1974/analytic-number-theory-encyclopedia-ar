...
\newcommand{\provedhere}{%
  \noindent\resultbadge{green!18}{مثبت هنا}\par
}
\newcommand{\citedresult}[1][المذكور في الشرح التالي]{%
  \noindent\resultbadge{blue!15}{مستشهد بها}\quad منقولة من المرجع #1.\par
}
\newcommand{\openresult}{%
  \noindent\resultbadge{orange!20}{مفتوحة}\par
}
\newcommand{\conditionalresult}{%
  \noindent\resultbadge{yellow!25}{مشروطة}\par
}
