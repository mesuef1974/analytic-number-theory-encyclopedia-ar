...
\symbolindex{مبرهنة بومبييري--فينوغرادوف والتوزيع المتوسطي للأعداد الأولية}
...
\symbolindex{الأخطاء ومستوى التوزيع}
...
\symbolindex{حزمة الغربال الكبير}

\theoremindex{الغربال الكبير للشخصيات والنسخة الثنائية العظمى}
...
\symbolindex{متراجحة بوليا--فينوغرادوف}

\theoremindex{بوليا--فينوغرادوف للشخصيات البدائية}
...
\symbolindex{الرد إلى النمطين الأول والثاني}
...
\theoremindex{تفكيك مجاميع فون مانغولت}
...
\symbolindex{متوسط مجاميع الشخصيات}
...
\symbolindex{تقدير النمط الأول}

\theoremindex{تقديرات Type I}
...
\symbolindex{تقدير النمط الثاني}

\theoremindex{تقديرات Type II}
...
\theoremindex{مبرهنة القيمة المتوسطة للشخصيات البدائية}
...
\symbolindex{من الشخصيات إلى الفئات الحسابية}
...
\symbolindex{مبرهنة بومبييري--فينوغرادوف}

\theoremindex{بومبييري--فينوغرادوف}
...
\section{نتائج تابعة}
\symbolindex{نتائج تابعة}

\theoremindex{النسخة الموافقة لـ\(\vartheta\)}
...
\theoremindex{النسخة الموافقة لـ\(\pi\)}
...
\theoremindex{تقريبًا كل الترديدات}
...
\symbolindex{مقارنة النتائج الثلاث}
...
\personindex{غولدباخ، كريستيان}
  ...
  \item لا تعني حالة \textenglish{VERIFIED} أن الفصل اجتاز المراجعة المستقلة
  أو أصبح \textenglish{RELEASE-READY}.
\end{itemize}
