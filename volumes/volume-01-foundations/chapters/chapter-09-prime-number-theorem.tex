...
\symbolindex{مبرهنة الأعداد الأولية}

\section{نطاق الفصل وحالته}

\noindent\textbf{حالة الفصل:} \textenglish{REVIEWED}. يثبت هذا الفصل الصيغة
المركزية
\[
\psi(x)\sim x,
\]
...
\begin{itemize}
  ...
  \item \texttt{docs/CHAPTER\_09\_INDEPENDENT\_REVIEW\_2026-07-20.md}.
\end{itemize}
تعني حالة \textenglish{REVIEWED} أن الفصل اجتاز المراجعة الثانية
المستقلة بحكم \textenglish{APPROVED} على الالتزام
\texttt{44dc9e433f262ac71ceb52f59ed5b59c77e58832}، بلا تصحيحات إلزامية.
ولا تعني هذه الحالة أن الفصل \textenglish{RELEASE-READY}، ولا تجيز دمج
طلب السحب من دون أمر صريح من مالك المشروع.
...
\symbolindex{حد تشيبيشيف وضبط القوى الأولية العليا}

\theoremindex{حد تشيبيشيف ولمّة القوى الأولية العليا}
...
\symbolindex{المشتقة اللوغاريتمية وتمثيل ستيلتج}
...
\theoremindex{تمثيل المشتقة اللوغاريتمية بواسطة \(\psi\)}
...
\symbolindex{المتراجحة الموزونة لزيتا}
...
\theoremindex{المتراجحة الموزونة للمشتقة اللوغاريتمية}
...
\symbolindex{عدم وجود أصفار على الخط \(\Re(s)=1\)}

\theoremindex{مبرهنة Hadamard--de la Vallée Poussin النوعية}
...
\symbolindex{مبرهنة Wiener--Ikehara}
...
\theoremindex{Wiener--Ikehara، صيغة المتسلسلات الديريشلية}
...
\symbolindex{إزالة القطب عند الواحد}
...
\symbolindex{الصيغة المركزية لمبرهنة الأعداد الأولية}

\theoremindex{مبرهنة الأعداد الأولية بصيغة فون مانغولت}
...
\symbolindex{الانتقال إلى \(\vartheta\) و\(\pi\)}

\theoremindex{الصيغة المكافئة بدالة تشيبيشيف الأولى}
...
\theoremindex{مبرهنة الأعداد الأولية}
...
\symbolindex{المسار الأولي المنفصل}
...
\symbolindex{خريطة الاعتماد المنطقي}
...
اجتاز الفصل المراجعة الثانية المستقلة بحكم \textenglish{APPROVED}،
وسُجل الحكم في تقرير المراجعة المستقلة للفصل التاسع. ويبقى الدمج خطوة
منفصلة لا تنفذ إلا بأمر صريح من مالك المشروع.
