...
\symbolindex{مبرهنة ديريشليه للأوليات في المتتاليات الحسابية}
...
\symbolindex{مرشح الفئة الحسابية}
...
\theoremindex{مرشح الفئة بالشخصيات}
...
\symbolindex{لوغاريتم المنتج الأويلري}
...
\theoremindex{ضبط القوى الأولية العليا}
...
\symbolindex{فصل الشخصية الرئيسية}

\theoremindex{مساهمة الشخصية الرئيسية}
...
\theoremindex{مساهمة الشخصيات غير الرئيسية}
...
\symbolindex{تباعد مجموع مقلوبات الأوليات}

\theoremindex{مبرهنة ديريشليه للأوليات في المتتاليات الحسابية}
