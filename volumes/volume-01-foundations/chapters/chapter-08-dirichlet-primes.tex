...
\noindent\textbf{حالة الفصل:} \textenglish{VERIFIED}. يثبت هذا الفصل أن كل
...
ومراجعة تحريرية ومرجعية. ولا تعني حالة \textenglish{VERIFIED} اكتمال
المراجعة الثانية المستقلة المطلوبة قبل \textenglish{REVIEWED}.
