...
\texttt{docs/CHAPTER\_11\_LOGIC\_AUDIT\_2026-07-20.md}. ولا يدعي الفصل
أفضل ثابت عددي، ولا يثبت البرهان الكامل لظاهرة Deuring--Heilbronn، ولا
يتناول Siegel--Walfisz أو Bombieri--Vinogradov أو Linnik، ولا يستعمل فرضية
ريمان المعممة. وتبقى منطقة Vinogradov--Korobov وتقديرات كثافة الأصفار
موضوعين متقدمين مؤجلين.
...
\begin{enumerate}
  ...
  \item شرح مبرهنة Siegel ومعنى عدم فعالية ثابتتها.
...
\cite{BenliGoelTwissZaman2026}. ولا ندعي هنا البرهان الكامل، الذي يستعمل
أدوات تتجاوز الفصول الحالية.
...
لدوال الشخصيات، مع القطع وتقدير الأخطاء، فمؤجلة إلى فصل كمي لاحق.
