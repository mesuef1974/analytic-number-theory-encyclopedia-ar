...
\symbolindex{المناطق الخالية من الأصفار والأصفار الاستثنائية}
...
\symbolindex{المقياس التحليلي وثلاثة معاني للفرادة}
...
\symbolindex{الرد إلى الشخصية البدائية}

\theoremindex{الأصفار القريبة من الواحد والجد البدائي}
...
\symbolindex{الدالة المكتملة والمشتقة اللوغاريتمية}
...
\theoremindex{صيغة المشتقة اللوغاريتمية بمجموع على الأصفار}
...
\theoremindex{ضبط الباقي المنتظم}
...
\symbolindex{المتراجحة الموزونة}
...
\symbolindex{المنطقة القياسية الخالية}

\theoremindex{المنطقة القياسية والاستثناء الحقيقي}
...
\symbolindex{مبرهنة Landau--Page}

\theoremindex{مبرهنة Landau--Page النوعية}
...
\symbolindex{مبرهنة Siegel وعدم الفعالية}

\theoremindex{مبرهنة Siegel}
...
\theoremindex{حد المشتقة قرب الواحد}
...
\theoremindex{الإبعاد غير الفعال للصفر الاستثنائي}
...
\symbolindex{ظاهرة Deuring--Heilbronn}
...
\theoremindex{ظاهرة Deuring--Heilbronn، صيغة نوعية}
...
\symbolindex{الأثر في توزيع الأوليات}
...
\theoremindex{خريطة الأثر في الصيغة الصريحة}
