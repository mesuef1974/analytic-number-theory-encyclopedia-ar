...
\symbolindex{مبرهنة الأعداد الأولية في المتتاليات الحسابية}

\section{نطاق الفصل وحالته}

\noindent\textbf{حالة الفصل:} \textenglish{REVIEWED}. يثبت هذا الفصل، لكل
...
\begin{itemize}
  \item سجل أدلة الفصل العاشر في مجلد مراجعات الأدبيات.
  \item خريطة برهان الفصل العاشر في مجلد مراجعات الأدبيات.
  ...
  \item \texttt{docs/CHAPTER\_10\_INDEPENDENT\_REVIEW\_2026-07-20.md}.
\end{itemize}

تعني حالة \textenglish{REVIEWED} أن النتائج الداخلية السبع اجتازت تدقيق
الإشارات وعدم الدور، والتحقق المرجعي، وتدقيق ما بعد التأليف، ثم اجتاز
الفصل مراجعة ثانية مستقلة بحكم \textenglish{APPROVED} من دون تصحيحات حاجزة.
ولا تمنح هذه الحالة وصف \textenglish{RELEASE-READY}.
...
\personindex{زيغل، كارل لودفيغ}
\personindex{والفيش، أرنولد}
...
\symbolindex{دوال العد في فئة حسابية}
...
\symbolindex{سلسلة فون مانغولت في الفئة}
...
\theoremindex{تفكيك سلسلة الفئة بواسطة الشخصيات}
...
\symbolindex{المتراجحة الموزونة لدوال \(L\)}
...
\theoremindex{المتراجحة الموزونة للمشتقات اللوغاريتمية}
...
\symbolindex{عدم انعدام دوال \(L\) على الخط الواحد}

\theoremindex{عدم الانعدام على \(\Re(s)=1\)}
...
\symbolindex{عزل قطب الشخصية الرئيسية}

\theoremindex{امتداد سلسلة الفئة بعد طرح القطب}
...
\symbolindex{الصيغة المركزية في الفئة}
...
\theoremindex{مبرهنة الأعداد الأولية الموزونة في فئة ثابتة}
...
\theoremindex{الصيغة الموزونة على الأوليات فقط}
...
\symbolindex{الانتقال إلى دالة العد}

\theoremindex{مبرهنة الأعداد الأولية في متتالية حسابية ثابتة}
