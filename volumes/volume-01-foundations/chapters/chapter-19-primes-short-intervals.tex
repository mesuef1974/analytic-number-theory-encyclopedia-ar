...
\noindent\textbf{حالة الفصل:} \textenglish{AUTHORED-DRAFT / NON-CITABLE}. أُنشئ المتن بعد اجتياز بوابة ما قبل التأليف بحكم مستقل \textenglish{PASS}، لكنه لم يخضع بعد لبناء الدفعة النهائي، أو التدقيق الرياضي والمرجعي، أو المراجعة المستقلة للمتن، أو اعتماد المالك.
...
\begin{theorem}[Guth--Maynard: صيغة تقاربية في فترات قصيرة]
\label{thm:guth-maynard-short-intervals}
\resultid{ANT-THM-19-01}
\citedresult[\cite[Corollary~1.3]{GuthMaynard2026}]
...
\begin{theorem}[Baker--Harman--Pintz: حد سفلي من الرتبة الصحيحة]
\label{thm:bhp-short-interval-lower-bound}
\resultid{ANT-THM-19-02}
\citedresult[\cite[خاتمة ص.~561]{BakerHarmanPintz2001}]
لكل \(x\) كبير بما يكفي:
\[
