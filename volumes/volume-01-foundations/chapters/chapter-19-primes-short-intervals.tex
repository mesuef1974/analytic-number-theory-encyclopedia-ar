...
\symbolindex{الأوليات في الفترات القصيرة}
...
\noindent\textbf{حالة الفصل:} \textenglish{REVIEWED / OWNER-ADOPTED / CITABLE}. اجتاز المتن بناء الدفعة والتدقيق الرياضي والمرجعي والمراجعة المستقلة، وأُغلقت ملاحظتاه الطباعيتان غير الحاجزتين، ثم اعتمده مالك المشروع وأذن بدمجه.
...
\symbolindex{أربعة أهداف مختلفة}
...
\symbolindex{فروق دوال تشيبيشيف}
...
\theoremindex{هوية فرق فون مانغولت}
...
\symbolindex{مبدأ نقل حد الخطأ}

\theoremindex{نقل حد خطأ معطى إلى فرق قصير}
...
\symbolindex{إزالة القوى الأولية العليا}
...
\theoremindex{ضبط القوى العليا في فترة قصيرة}
...
\symbolindex{الانتقال من \(\vartheta\) إلى \(\pi\)}

\theoremindex{حصار العد غير الموزون}
...
\symbolindex{المسار التاريخي: من Hoheisel إلى Huxley}
...
\symbolindex{السجل التقاربي الحديث}

\theoremindex{Guth--Maynard}
...
\personindex{ديريشليه، يوهان بيتر غوستاف}
...
\symbolindex{فترة أقصر بنتيجة أضعف نوعيًا}

\theoremindex{Baker--Harman--Pintz}
...
\begin{remark}[تمركز الفترة]
تُعرض نتيجة Baker--Harman--Pintz هنا بصيغة الفترة الأمامية
\[
(x,x+x^{0.525}],
\]
وهي الصيغة التي يصف بها المصدر المنشور نتيجته. ويمكن نقل نتائج وجود
مماثلة بين فترات أمامية وخلفية بعد تغيير متغير الأساس، لكن ذلك انتقال
منفصل ولا يُستعمل لتبرير الصياغة أعلاه.
\end{remark}
...
\symbolindex{من وجود أولي إلى فجوة بين أوليين متتاليين}

\theoremindex{حد الفترة يعطي حد الفجوة}
...
\symbolindex{ما الذي تصنعه الصيغة الصريحة؟}
...
\begin{center}
\begin{tabular}{ll}
\texttt{ANT-DEF-19-01} & \texttt{ACTIVE / CITABLE / DEFINITION}\\
\texttt{ANT-ID-19-01} & \texttt{ACTIVE / CITABLE / PROVED-HERE}\\
\texttt{ANT-PROP-19-01} & \texttt{ACTIVE / CITABLE / PROVED-HERE}\\
\texttt{ANT-LEM-19-01} & \texttt{ACTIVE / CITABLE / PROVED-HERE}\\
\texttt{ANT-PROP-19-02} & \texttt{ACTIVE / CITABLE / PROVED-HERE}\\
\texttt{ANT-THM-19-01} & \texttt{ACTIVE / CITABLE / CITED-EXPLAINED}\\
\texttt{ANT-THM-19-02} & \texttt{ACTIVE / CITABLE / CITED}\\
\texttt{ANT-COR-19-01} & \texttt{ACTIVE / CITABLE / PROVED-HERE}
\end{tabular}
\end{center}

جميع النتائج الثماني \textenglish{ACTIVE / CITABLE} بعد نجاح البناء، والتدقيق الرياضي والمرجعي، والمراجعة المستقلة للمتن، وقرار المالك الصريح.
