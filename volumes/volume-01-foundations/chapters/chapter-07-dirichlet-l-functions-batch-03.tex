...
نثبت أولًا الحقائق البنيوية التي تضبط جذر العدد والمشتقة
اللوغاريتمية، ثم ننتقل إلى عدم الانعدام عند \(s=1\).

\theoremindex{توافق جذري العدد في المعادلة الوظيفية}
\symbolindex{جذر العدد \(\varepsilon(\chi)\)}
...
\symbolindex{المشتقة اللوغاريتمية \(-L'/L\)}
...
\begin{proof}
من المنتج الأويلري وعدم الانعدام في \(\Re(s)>1\) نعرّف الفرع الهولومورفي
لـ\(\log L(s,\chi)\) بواسطة السلسلة الأويلرية المطلقة
\[
\log L(s,\chi)
=
...
\frac{\chi(p)^k}{k p^{ks}}.
\]
هذا التحديد يثبت الفرع المقصود ولا يفترض اختيارًا عالميًا سابقًا
للوغاريتم. وتتقارب السلسلة مطلقًا ومحليًا بانتظام، وبالتفاضل حدًا حدًا:
\[
-\frac{L'}{L}(s,\chi)
=
\sum_p\sum_{k=1}^{\infty}
...
\theoremindex{عدم انعدام \(L(1,\chi)\) للشخصيات غير الرئيسية}
...
\symbolindex{فرضية ريمان المعممة لدوال ديريشليه}
