...
\symbolindex{مبرهنة سيغل--فالفش والتوزيع المنتظم للأعداد الأولية}
...
\symbolindex{ثلاث طبقات يجب عدم خلطها}
...
\symbolindex{دوال العد والمرشح بالشخصيات}
...
\symbolindex{الرد إلى الجد البدائي}

\theoremindex{رد مجموع فون مانغولت إلى الشخصية البدائية}
...
\symbolindex{مدخلان مقتبسان من النظرية الكمية}
...
\theoremindex{حد دو لا فاليه بوسان لمبرهنة الأعداد الأولية}
...
\theoremindex{الصيغة الصريحة الكمية بعد عزل الاستثناء}
\begin{theorem}[الصيغة الصريحة الكمية بعد عزل الاستثناء]
...
\symbolindex{اختيار ارتفاع القطع وضبط الجزء غير الاستثنائي}

\theoremindex{اختيار الارتفاع اللوغاريتمي}
...
\symbolindex{الصفر الاستثنائي وموضع استعمال مبرهنة سيغل}
...
\theoremindex{امتصاص حد الصفر الاستثنائي}
...
\symbolindex{مبرهنة سيغل--فالفش}

\theoremindex{مبرهنة سيغل--فالفش في صيغة \(\psi\)}
...
\symbolindex{الادخار اللوغاريتمي الاعتباطي}

\theoremindex{صيغة سيغل--فالفش اللوغاريتمية}
...
\symbolindex{الانتقال إلى \(\vartheta(x;q,a)\)}

\theoremindex{التوزيع المنتظم للدالة \(\vartheta\)}
...
\symbolindex{الانتقال إلى \(\pi(x;q,a)\)}
...
\theoremindex{التوزيع المنتظم لعدد الأوليات}
...
\symbolindex{قراءة النتيجة وحدودها}

\subsection{ما الذي أضيف إلى الفصل العاشر؟}
\symbolindex{ما الذي أضيف إلى الفصل العاشر؟}
...
\symbolindex{لماذا المجال لوغاريتمي؟}
...
\symbolindex{الفعالية وعدم الفعالية}
