...
\symbolindex{الأشكال المعيارية وأشكال مااس وصيغ التتبع}
...
\personindex{بيترسون، هانس}
\personindex{كوزنتسوف، نيكولاي}
...
\textenglish{REVIEWED / OWNER-ADOPTED / CITABLE}. اجتاز الفصل البناء
والتدقيق والمراجعة المستقلة بعد التأليف، وأُغلقت ملاحظات الاكتمال، ثم
اعتمده مالك المشروع صراحةً وفعّل نتائجه الخمس عشرة.
...
\symbolindex{الفضاء العلوي والهندسة الزائدية}
...
\theoremindex{هويات الفعل وثبات القياس}
...
\symbolindex{الأشكال المعيارية الهولومورفية}
...
\citedresult[\cite{DiamondShurman2005}، Ch.~1]
...
\theoremindex{سلامة تعريف حاصل Petersson}
...
\citedresult[\cite{Iwaniec2002}، Chs.~3--4]
...
\theoremindex{فصل المتغيرات وتوسع Fourier--Whittaker}
\begin{theorem}[فصل المتغيرات وتوسع Fourier--Whittaker]
\label{prop:maass-fourier-whittaker}
\resultid{ANT-THM-20-02}
\citedresult[\cite{Kuznetsov1981}، \S2]
...
\symbolindex{مجاميع Kloosterman}
...
\citedresult[\cite{IwaniecKowalski2004}، Cor.~11.12]
لدينا
\[
|S(m,n;c)|
\le
...
\symbolindex{مدخل بنيوي إلى صيغة Selberg}
...
\begin{remark}[ما يبقى مؤجلًا]
تُؤجَّل المعالجة المستقلة لصيغة Selberg غير المدمجة وحدود المبعثرات؛
ولا تُسجَّل هذه الإحالة نتيجةً مستقلة ضمن نتائج الفصل.
\end{remark}
...
\symbolindex{مقارنة الصيغ الثلاث}
...
\symbolindex{كيف تخدم الصيغ نظرية الأعداد التحليلية؟}
...
\section*{حالة النتائج المعتمدة}

\begin{center}
\begin{tabular}{ll}
\textenglish{\texttt{ANT-DEF-20-01}} & \textenglish{\texttt{ACTIVE / PROVED-HERE}}\\
\textenglish{\texttt{ANT-PROP-20-01}} & \textenglish{\texttt{ACTIVE / PROVED-HERE}}\\
\textenglish{\texttt{ANT-DEF-20-02}} & \textenglish{\texttt{ACTIVE / CITED-DEFINITION}}\\
\textenglish{\texttt{ANT-LEM-20-01}} & \textenglish{\texttt{ACTIVE / PROVED-HERE}}\\
\textenglish{\texttt{ANT-DEF-20-04}} & \textenglish{\texttt{ACTIVE / CITED-DEFINITION}}\\
\textenglish{\texttt{ANT-PROP-20-02}} & \textenglish{\texttt{ACTIVE / PROVED-HERE}}\\
\textenglish{\texttt{ANT-THM-20-01}} & \textenglish{\texttt{ACTIVE / CITED}}\\
\textenglish{\texttt{ANT-DEF-20-03}} & \textenglish{\texttt{ACTIVE / CITED-DEFINITION}}\\
\textenglish{\texttt{ANT-THM-20-02}} & \textenglish{\texttt{ACTIVE / CITED}}\\
\textenglish{\texttt{ANT-DEF-20-05}} & \textenglish{\texttt{ACTIVE / PROVED-HERE / DEFINITION}}\\
\textenglish{\texttt{ANT-PROP-20-03}} & \textenglish{\texttt{ACTIVE / PROVED-HERE}}\\
\textenglish{\texttt{ANT-THM-20-03}} & \textenglish{\texttt{ACTIVE / CITED}}\\
\textenglish{\texttt{ANT-THM-20-04}} & \textenglish{\texttt{ACTIVE / CITED-CORE}}\\
\textenglish{\texttt{ANT-THM-20-05}} & \textenglish{\texttt{ACTIVE / CITED-CORE}}\\
\textenglish{\texttt{ANT-THM-20-06}} & \textenglish{\texttt{ACTIVE / COMPACT-PROTOTYPE}}
\end{tabular}
\end{center}

النتائج الخمس عشرة \textenglish{ACTIVE / CITABLE} بعد اكتمال بناء PDF
والتدقيق الرياضي والمرجعي والمراجعة المستقلة واعتماد المالك.
