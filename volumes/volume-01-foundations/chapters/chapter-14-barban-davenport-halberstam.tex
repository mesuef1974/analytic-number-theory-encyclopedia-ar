...
\symbolindex{مبرهنة باربان--دافنبورت--هالبرستام ومتوسط التباين التربيعي}
...
\symbolindex{التوسيط وتحويل التباين إلى الشخصيات}
...
\theoremindex{هوية التباين بالشخصيات}
...
\symbolindex{رد الشخصيات إلى الموصلات}
...
\theoremindex{كلفة تصحيحات الاستحثاث}
...
=
\sum_{p\mid n}1
+2\sum_{\substack{p<\ell\\p\ell\mid n}}1,
\]
...
\symbolindex{الغربال الكبير الموزون}
...
\theoremindex{الغربال الكبير بوزن الموصل}
...
\symbolindex{مبرهنة باربان--دافنبورت--هالبرستام في المجال الكلاسيكي}

\theoremindex{حد باربان--دافنبورت--هالبرستام الكلاسيكي}
\begin{theorem}[حد باربان--دافنبورت--هالبرستام الكلاسيكي]
...
من الأخرى مباشرة بالتطبيع المستعمل هنا. ولا يستعمل هذا الفصل مبرهنة
بومبييري--فينوغرادوف تحديدًا؛ أما اعتماده الوحيد على الفصل الثالث عشر فهو
حزمة الغربال الكبير المذكورة أعلاه.
\end{remark}

\section{المسار المؤجل وعائق التصادمات الضربية}
\symbolindex{المسار المؤجل وعائق التصادمات الضربية}
...
\begin{enumerate}
  ...
  \item تعميم التحليل إلى متوسطات التباين على ألياف البواقي والموصلات.
\end{enumerate}
