...
عمليًّا يتطابق المعياران عند كل \(N\) منتهٍ لا تقاربيًّا فحسب: المعيار
المؤثِّري لـ\(K\) (الصيغة الثنائية) يساوي بالضبط أكبر قيمة ذاتية مطلقة
لـ\(iK\) (الصيغة التربيعية) — تحقَّق عدديًّا بمقارنة المعيارين مباشرةً
عند \(N=10,50,200,1000\)، فتطابقا في كل حالة. فلا فجوة في النقل.
\end{remark}
