...
\(iK\) هرميتية و\(S(z)=-i\,z^{*}(iK)z\)، ومن ثَمّ
\(\lvert S(z)\rvert=\lvert z^{*}(iK)z\rvert\). وللمصفوفات الهرميتية
يساوي النصف القطري العددي نصف القطر الطيفي، فيكون \(Q_N\) أكبر قيمة
ذاتية مطلقة لـ\(iK\).
