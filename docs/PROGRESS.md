...
4. Hoheisel--Ingham--Huxley بوصفها طبقة تاريخية، مع حجب ثابت Hoheisel العددي.
5. Guth--Maynard المنشورة في 2026 عند \(17/30+\varepsilon\) بوصفها السجل التقاربي الحديث المقتبس.
6. نتيجة Baker--Harman--Pintz عند \(0.525\) بوصفها حدًا سفليًا مقتبسًا من الرتبة الصحيحة.
7. إبقاء ادعاء \(0.52\) في preprint داخل الحجر العلمي.
8. ربط الفترات القصيرة بفجوات الأوليات من دون عكس منطقي غير مشروع.
