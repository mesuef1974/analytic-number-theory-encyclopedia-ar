...
| `ANT-THM-12-02` | الصيغة الصريحة المقطوعة الموحدة بعد عزل الصفر الاستثنائي | الفصل 12 | `CITED / COMPOSITE-INPUT` | Davenport (2000), Montgomery--Vaughan (2007)؛ مدخل مركب مع ديون Perron وتحويل المسار معلنة |
...
|---|---|---|
| صيغة بيرون المقطوعة والمملسة | `DEFERRED` | فصل مستقل لصيغة بيرون؛ استعمل الفصل 12 صيغة صريحة محددة بحالة `CITED / COMPOSITE-INPUT` |
...
الفصول من السابع إلى الثاني عشر بحالة `REVIEWED`، والفصل الثالث عشر بحالة
`VERIFIED` بعد اجتياز التدقيق المنطقي والمرجعي وتدقيق ما بعد التأليف وفحوص
الجودة والبناء. لا تعني حالة أي فصل `RELEASE-READY`.
