...
3. مبرهنة هالاش تعطي حدًا علويًا لمتوسط دالة ضربـية 1-bounded بدلالة أفضل اقتراب من \(n^{it}\) على مجال مضبوط لـ\(t\).
4. عدم الادعاء تجاه جميع النماذج المناسبة يقود إلى الإلغاء المتوسط، لكنه لا يعني تلقائيًا إلغاءً نقطيًا ولا نتائج فترات قصيرة.
5. انتقالات Matomäki–Radziwiłł إلى الفترات القصيرة مؤجلة ولا تُدمج في نواة هذا الفصل.
...
- أي صيغة كمية ستُجمّد في جدول التطبيعات قبل التأليف.
